...
write.csv(medians.by.districts, file = 'Outputs/median_district_result_jan.csv', col.names = FALSE)
...
write.csv(medians.by.governorate, file = 'Outputs/median_dec_governorate_result.csv', row.names = FALSE)
